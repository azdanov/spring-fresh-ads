...
public class CategoryServiceImpl implements CategoryService {
  ...
  public CategoryServiceImpl(CategoryRepository categoryRepository, NestedNodeRepository<Integer, Category> categoryNestedNodeRepository) {
  ...
  public List<CategoryTreeDTO> getAllCategories() {
    ...
    return roots.stream()
        .map(category -> getCategoryTreeDTORecursive(categoryNestedNodeRepository.getTree(category)))
        .toList();
  }
  ...
  private CategoryTreeDTO getCategoryTreeDTORecursive(Tree<Integer, Category> tree) {
    ...
    return new CategoryTreeDTO(category.getName(), category.getSlug(), category.getPrice(), processTreeList(children));
  }
